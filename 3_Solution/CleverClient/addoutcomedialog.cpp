...
{
	setupUi(this);
	this->cardCurrencyISO->setReadOnly(true);
}
...
void AddOutComeDialog::on_cardsOutcomeComboBox_currentTextChanged(const QString& cardNameSelected)
{
	this->cardCurrencyISO->setText(this->map_cards[this->cardsOutcomeComboBox->currentText().toStdString()].getCardCurrencyISO());
}
