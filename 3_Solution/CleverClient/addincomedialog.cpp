...
void AddIncomeDialog::on_cardsIncomeComboBox_currentTextChanged(const QString& cardNameSelected)
{
	this->cardCurrencyISO->setText(this->map_cards[this->cardsIncomeComboBox->currentText().toStdString()].getCardCurrencyISO());
}
